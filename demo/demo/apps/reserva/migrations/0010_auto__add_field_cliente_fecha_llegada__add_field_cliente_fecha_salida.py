...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'cliente.fecha_llegada'
        db.add_column(u'reserva_cliente', 'fecha_llegada',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Adding field 'cliente.fecha_salida'
        db.add_column(u'reserva_cliente', 'fecha_salida',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'cliente.fecha_llegada'
        db.delete_column(u'reserva_cliente', 'fecha_llegada')

        # Deleting field 'cliente.fecha_salida'
        db.delete_column(u'reserva_cliente', 'fecha_salida')
