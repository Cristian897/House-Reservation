...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'producto.fecha_final'
        db.add_column(u'reserva_producto', 'fecha_final',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'producto.fecha_final'
        db.delete_column(u'reserva_producto', 'fecha_final')
