...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reserva_producto', 'fecha_inicio', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'producto.fecha_inicio'
        db.alter_column(u'reserva_producto', 'fecha_inicio', self.gf('django.db.models.fields.DateField')(default=1))
